...
FOUNDATION_EXTERN TTEventName const TTEventNameLoanApplication __deprecated_msg("This event is deprecated");
FOUNDATION_EXTERN TTEventName const TTEventNameLoanApproval __deprecated_msg("This event is deprecated");
FOUNDATION_EXTERN TTEventName const TTEventNameLoanDisbursal __deprecated_msg("This event is deprecated");
